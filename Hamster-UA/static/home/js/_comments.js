...
const reviews_data = [
  {
    ...
    name: "Ірина Шевченко",
    comment:
      "Hamster Casino – це просто знахідка для всіх любителів азартних ігор! Величезний вибір слотів і настільних ігор, все працює бездоганно. Особливо подобаються регулярні бонуси та акції. Рекомендую всім!",
  },
  {
    img: "../../media/photos/comments/comment10.png",
    name: "Олександр Пилипенко",
    comment:
      "Дуже подобається цей додаток! Графіка на висоті, а самі ігри захоплюють. Єдине, хотілося б більше варіантів для виведення коштів. Загалом, чудовий додаток для розваг",
  },
  {
    img: "../../media/photos/comments/comment3.png",
    name: "Андрій Левченко",
    comment:
      "Непоганий додаток, багато цікавих ігор і регулярні оновлення. Єдине, що іноді виникають технічні проблеми, але підтримка реагує швидко. Усе інше на високому рівні.",
  },
  {
    img: "../../media/photos/comments/comment4.png",
    name: "Марина Коваль",
    comment:
      "Hamster Casino – це справжнє відкриття для мене! Граю щодня і завжди задоволена. Дуже подобаються турніри і змагання з іншими гравцями. Інтерфейс зручний і зрозумілий.",
  },
  {
    img: "../../media/photos/comments/comment6.png",
    name: "Ольга Мельник",
    comment:
      "Захоплюючий додаток з чудовим вибором ігор! Всі транзакції швидкі та безпечні. Дуже зручно грати з мобільного телефону в будь-який час. Hamster Casino – найкраще казино в моєму досвіді!",
  },
];
